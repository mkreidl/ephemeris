...
public class Stereographic
{
    ...
    public Stereographic( double origin )
    {
        this.origin = origin;
    }
    ...
    {
        final double stretch = 1.0 - origin * sin( lat );
    ...
    {
        double stretch = 1.0 - input.z / origin;
    ...
    {
        final double stretch = 1.0 - input.dst * sin( input.lat ) / origin;
     ...
     * the expression for r just calculated and thereby obtain
