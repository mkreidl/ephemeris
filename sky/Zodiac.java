...
public class Zodiac
{
    ...
    public final Spherical pole = new Spherical(
            1.0, -Math.PI / 2, Math.PI / 2 - SolarSystem.getEcliptic( new Time() ) );
    ...
    public double calculate( Time time )
    {
        obliquity = SolarSystem.getEcliptic( time );
    ...
    {
        cartesian.set( direction );
        return sign.posCart.toEquatorial( obliquity, cartesian );
    }

    public Cartesian getEquatorialDirectionMiddle( Sign sign, Cartesian direction )
    {
        cartesian.set( direction );
        return sign.posCartMiddle.toEquatorial( obliquity, cartesian );
    }
