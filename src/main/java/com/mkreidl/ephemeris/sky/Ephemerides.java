...
public class Ephemerides
{
    ...
    void setGeocentricPosition( Ecliptical.Cart geocentric, Ecliptical.Cart earth )
    {
    ...
    void setHeliocentricVelocity( Ecliptical.Cart velBody, Ecliptical.Cart velEarth )
    {
    ...
    void setGeocentricVelocity( Ecliptical.Cart velBody, Ecliptical.Cart velEarth )
    {
