...
public class Constellations
{
    public static final Constellation AQUARIUS = new Constellation( "Aquarius",
            new Integer[]{395, 1164, 157, 686},
            new Integer[]{157, 164, 1084, 997, 535},
            new Integer[]{997, 431, 164, 615, 2494, 377, 642, 797, 348},
            new Integer[]{507, 797, 230, 526, 377} );
    public static final Constellation AQUILA = new Constellation( "Aquila",
            new Integer[]{271, 250, 169, 11, 365, 217, 468, 250, 11, 119} );
    public static final Constellation ARA = new Constellation( "Ara",
            new Integer[]{163, 142, 200, 387},
            new Integer[]{200, 555},
            new Integer[]{243, 334} );
    public static final Constellation ARIES = new Constellation( "Aries",
            new Integer[]{1313, 105, 48, 337} );
    public static final Constellation CANCER = new Constellation( "Cancer",
            new Integer[]{665, 483, 289},
            new Integer[]{483, 1075, 529} );
    public static final Constellation CAPRICORNUS = new Constellation( "Capricornus",
            new Integer[]{315, 190, 603, 586, 900, 376, 1102,
                    147, 354, 696, 564, 2105, 315} );
    public static final Constellation CRATER = new Constellation( "Crater",
            new Integer[]{1124, 1324, 308, 567, 1159, 2015},
            new Integer[]{567, 879, 566, 308} );
    public static final Constellation DELPHINUS = new Constellation( "Delphinus",
            new Integer[]{339, 394, 685, 832, 339, 540} );
    public static final Constellation GEMINI = new Constellation( "Gemini",
            new Integer[]{46, 808, 165, 148, 231},
            new Integer[]{15, 554, 294, 399, 42},
            new Integer[]{294, 316, 248},
            new Integer[]{165, 605},
            new Integer[]{324, 808, 400, 554, 312} );
    public static final Constellation LEO = new Constellation( "Leo",
            new Integer[]{21, 291, 166, 719, 857, 457, 270, 101, 95, 62, 242, 484, 547},
            new Integer[]{95, 242, 291, 101},
            new Integer[]{166, 457} );
    public static final Constellation LIBRA = new Constellation( "Libra",
            new Integer[]{232, 123, 102, 475, 318, 346},
            new Integer[]{123, 475} );
    public static final Constellation PISCES = new Constellation( "Pisces",
            new Integer[]{1054, 1195, 904, 1054, 2499, 330, 668,
                    732, 836, 1335, 2134, 687, 826, 527, 598,
                    698, 358, 1512, 902, 598} );
    public static final Constellation TAURUS = new Constellation( "Taurus",
            new Integer[]{171, 12, 257, 341, 385, 293, 26},
            new Integer[]{341, 276, 375, 470},
            new Integer[]{375, 321, 689} );
    public static final Constellation SCORPIO = new Constellation( "Scorpio",
            new Integer[]{79, 153, 13, 136, 75, 333, 240, 39, 181, 83, 115, 24, 214},
            new Integer[]{1464, 79, 152, 460} );
    public static final Constellation SAGITTARIUS = new Constellation( "Sagittarius",
            new Integer[]{193, 36, 118, 168},
            new Integer[]{118, 135, 444},
            new Integer[]{135, 208, 51, 154, 288},
            new Integer[]{51, 239, 100} );
    public static final Constellation VIRGO = new Constellation( "Virgo",
            new Integer[]{463, 329, 537, 592, 463, 342, 251, 568, 459},
            new Integer[]{14, 787, 342, 255, 138},
            new Integer[]{251, 673, 368} );

    public static final Constellation ANDROMEDA = new Constellation( "Andromeda",
            new Integer[]{817, 553, 777, 225, 758, 712, 336},
            new Integer[]{55, 445, 928, 658, 311},
            new Integer[]{72, 55, 225, 54},
            new Integer[]{712, 604, 417},
            new Integer[]{55, 758} );
    public static final Constellation AURIGA = new Constellation( "Auriga",
            new Integer[]{5, 367, 40, 103, 26/* =Beta tauri; alternatively: Chi aurigae=1197 */, 112, 204, 5},
            new Integer[]{40, 5, 167, 378} );
    public static final Constellation BOOTES = new Constellation( "Boötes",
            new Integer[]{110, 2, 317, 180, 286, 279, 117, 2, 829},
            new Integer[]{180, 621, 945, 549, 621} );
    public static final Constellation CANIS_MAIOR = new Constellation( "Canis Major",
            new Integer[]{0, 45, 488, 450, 22, 277, 35, 435, 88},
            new Integer[]{35, 179, 1095, 0, 780, 590, 559, 780} );
