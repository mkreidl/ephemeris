...
public class VSOP87CTest extends VSOP87Test
{
    ...
    public void testModel()
    {
        ...
        {
            case MER:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.MERCURY );
                break;
            case VEN:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.VENUS );
                break;
            case EAR:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.EARTH );
                break;
            case MAR:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.MARS );
                break;
            case JUP:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.JUPITER );
                break;
            case SAT:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.SATURN );
                break;
            case URA:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.URANUS );
                break;
            case NEP:
                model = AbstractModelVsop87.getVersionC( AbstractModelVsop87.NEPTUNE );
                break;
            default:
                model = null;
        }
