...
{
    private static final double toleranceJulianDayNumber = 1e-7;
    private static final double toleranceSiderealTime = 2.0 / 3600.0;
    private static Time julianDate = new Time();
    ...
    public TimeTest( String dateString, double JD, String siderealTime )
    {
        ...
        final long hours = Long.parseLong( siderealHHmmss[0] );
        final long mins = Long.parseLong( siderealHHmmss[1] );
        final long secs = Long.parseLong( siderealHHmmss[2] );
