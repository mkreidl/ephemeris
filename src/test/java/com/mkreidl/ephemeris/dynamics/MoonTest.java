...
public class MoonTest
{
    ...
    private final Spherical refSpherical = new Spherical(
            60.793 * SolarSystem.Body.EARTH.RADIUS_EQUATORIAL_M, 306.94 * DEG, -0.55 * DEG
    );

    @Test
    public void testCalculate()
    {
        moon.compute( time, posCartesian );
        ...
        assertEquals( 60.2666 * SolarSystem.Body.EARTH.RADIUS_EQUATORIAL_M, orbitalEl.axis, 1e-12 );
