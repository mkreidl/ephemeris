...
public abstract class RiseSetTest {
  ...
  public RiseSetTest(Spherical geographicLocation, String startTime, long searchDirection, RiseSetCalculator.EventType eventType, String eventTime) {
  ...
  public void test() throws ParseException {
    ...
    final long eventTimeCalculated = calculator.computeIterative(startTimeMs, PRECISION_MS);
