...
public class HorizontalCoordinatesTest
{
...

    {
        ...
        azimuth.put( SolarSystem.Body.MOON, new Angle( 15.6, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.SUN, new Angle( 13.5, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.SUN, new Angle( 136.6, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.MERCURY, new Angle( 7.1, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.MERCURY, new Angle( 131.5, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.VENUS, new Angle( -16.2, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.VENUS, new Angle( 110.3, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.MARS, new Angle( -37.1, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.MARS, new Angle( 81.4, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.JUPITER, new Angle( 36.9, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.JUPITER, new Angle( 166.3, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.SATURN, new Angle( -5.0, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.SATURN, new Angle( 116.7, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.URANUS, new Angle( -31.7, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.URANUS, new Angle( 338.2, Angle.Unit.DEGREES ) );

        height.put( SolarSystem.Body.NEPTUNE, new Angle( -47.2, Angle.Unit.DEGREES ) );
        azimuth.put( SolarSystem.Body.NEPTUNE, new Angle( 30.3, Angle.Unit.DEGREES ) );
    }
